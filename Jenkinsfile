    ...
    post {
        ...
        success {
            emailext (
                ...
                <p><b>Extent Report:</b> <a href="${env.BUILD_URL}artifact/src/test/resources/ExtentReports/ExtentReport.html">Click here</a></p>
                <p>Best regards,</p>
        ...
        failure {
            emailext (
                ...
                <p><b>Extent Report (if available):</b> <a href="${env.BUILD_URL}artifact/src/test/resources/ExtentReports/ExtentReport.html">Click here</a></p>
                <p>Best regards,</p>
                <p><b>Automation Team</b></p>
                </body>
                </html>
